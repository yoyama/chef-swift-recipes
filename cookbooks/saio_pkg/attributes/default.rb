...
default[:swift][:pkg_version] = "1.8.0-0ubuntu1.2~cloud0"
default[:swift][:client_pkg_version] = "1:1.3.0-0ubuntu1~cloud0"

default[:keystone][:pkg_version] = "1:2013.1.2-0ubuntu2~cloud0"
default[:keystone][:client_pkg_version] = "1:0.2.3-0ubuntu2.2~cloud0"
